...
import java.util.*;
import com.xworkz.superMarket.DTO.*;
import com.xworkz.superMarket.service.SuperMarketService;
import com.xworkz.superMarket.serviceImpl.SuperMarketServiceImpl;
...
public class SuperMarketRunner {
	...
	public static void main(String[] args) {
		...
		SuperMarketDTO dto3 = new SuperMarketDTO(3, "D mart", "D company", "22AAAAA0000A1Z7", 580023,
				"clothing and groceries");
		SuperMarketDTO dto4 = new SuperMarketDTO(4, "hyper market", "reliance", "22AAAAA0000A1Z6", 580022, "clothing");
		SuperMarketDTO dto5 = new SuperMarketDTO(5, "super market", "big bazar", "22AAAAA0000A1Z5", 580021,
				"groceries");
		SuperMarketDTO dto6 = new SuperMarketDTO(6, "reliance", "reliance", "22AAAAA0000A1Z6", 580022, "clothing");
		SuperMarketDTO dto7 = new SuperMarketDTO(7, "more", "D company", "22AAAAA0000A1Z7", 580023,
				"clothing and groceries");
		...
		SuperMarketDTO dto10 = new SuperMarketDTO(10, "more", "D company", "22AAAAA0000A1Z7", 580023,
				"clothing and groceries");
