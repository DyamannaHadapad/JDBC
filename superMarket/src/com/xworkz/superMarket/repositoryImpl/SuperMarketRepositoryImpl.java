package com.xworkz.superMarket.repositoryImpl;
import java.sql.*;
...
import com.xworkz.superMarket.constants.*;
...
public class SuperMarketRepositoryImpl implements SuperMarketRepository {
	...
	public boolean save(SuperMarketDTO dto) {
		...
		try {
			Connection connection = DriverManager.getConnection(MySQLDBSuperMarket.URL.getValues(), MySQLDBSuperMarket.USERNAME.getValues(),MySQLDBSuperMarket.HIDE.getValues());
